...
class ProxemicDetection(Node):
    ...
    def move_robot(self, x=0.0, z=0.0, clockwise=True):
        ...
        print("linear x:"+str(self.move_cmd.linear.x))
    ...
    def update_state_machine(self):
        ...
        if(self.curr_state == self.state1):
            ...
            while cnt < 3:
                ...
                self.move_robot(1.0, 0.0, True ) # Have robot move towards object
                cnt += 1
                self.robot_talker("You entered an public zone, rate your comfort level")
